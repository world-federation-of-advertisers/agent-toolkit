 ...
 *   • helia      — healthy launch (no pitfalls)
 *   • halcyon    — one publisher (Vega) over-saturates: 60% of impressions,
 *                  9% of reach, 53× frequency
 *   • aldea      — two publishers heavily overlap (89% of one inside the other)
 *
...
// ─────────────────────────────────────────────────────────────────────
// Fixture 1 — Helia Athletic, healthy launch
// ─────────────────────────────────────────────────────────────────────

const HELIA_POP = 50_000_000;
const HELIA_TOTAL_REACH = 18_000_000;
const HELIA_TOTAL_IMP = 69_000_000;

const HELIA: BasicReport = {
  name: "measurementConsumers/demo/basicReports/fixture_helia_q1",
  title: "Helia Athletic — Run 1 Launch",
  state: "SUCCEEDED",
  createTime: "2026-03-15T10:00:00Z",
  campaignGroupDisplayName: "Helia Athletic Run 1",
  campaignGroup: "measurementConsumers/demo/reportingSets/helia_run1",
      ...
      results: [
        {
          ...
          metricSet: {
            populationSize: String(HELIA_POP),
            reportingUnit: {
              cumulative: metrics({
                reach: HELIA_TOTAL_REACH,
                impressions: HELIA_TOTAL_IMP,
                populationSize: HELIA_POP,
              }),
...
// ─────────────────────────────────────────────────────────────────────
// Fixture 2 — Halcyon Vitamin-C Serum, saturation reveal
// ─────────────────────────────────────────────────────────────────────

const HAL_POP = 50_000_000;
const HAL_NET_REACH = 11_000_000;
const HAL_TOTAL_IMP = 88_000_000;

const HALCYON: BasicReport = {
  name: "measurementConsumers/demo/basicReports/fixture_halcyon_q1",
  title: "Halcyon Vitamin-C Serum — Q1 Launch",
  state: "SUCCEEDED",
  createTime: "2026-03-18T10:00:00Z",
  campaignGroupDisplayName: "Halcyon V-C Serum Launch",
  campaignGroup: "measurementConsumers/demo/reportingSets/halcyon_vc_q1",
      ...
      results: [
        {
          ...
          metricSet: {
            populationSize: String(HAL_POP),
            reportingUnit: {
              cumulative: metrics({
                reach: HAL_NET_REACH,
                impressions: HAL_TOTAL_IMP,
                populationSize: HAL_POP,
              }),
...
// ─────────────────────────────────────────────────────────────────────
// Fixture 3 — Aldea Coffee, heavy overlap (XMM-only insight)
// ─────────────────────────────────────────────────────────────────────

const ALDEA_POP = 60_000_000;
const ALDEA_NET_REACH = 22_000_000;
const ALDEA_TOTAL_IMP = 138_000_000;

const ALDEA: BasicReport = {
  name: "measurementConsumers/demo/basicReports/fixture_aldea_q1",
  title: "Aldea Coffee — Brand Awareness Q1",
  state: "SUCCEEDED",
  createTime: "2026-03-20T10:00:00Z",
  campaignGroupDisplayName: "Aldea Coffee Brand Awareness",
  campaignGroup: "measurementConsumers/demo/reportingSets/aldea_aware_q1",
      ...
      results: [
        {
          ...
          metricSet: {
            populationSize: String(ALDEA_POP),
            reportingUnit: {
              cumulative: metrics({
                reach: ALDEA_NET_REACH,
                impressions: ALDEA_TOTAL_IMP,
                populationSize: ALDEA_POP,
              }),
...
export const FIXTURE_REPORTS: BasicReport[] = [HELIA, HALCYON, ALDEA];
...
export const FIXTURE_EVENT_GROUPS = [
  {
    name: "measurementConsumers/demo/eventGroups/eg_orion_helia",
  ...
  {
    name: "measurementConsumers/demo/eventGroups/eg_cygnus_helia",
  ...
  {
    name: "measurementConsumers/demo/eventGroups/eg_vega_halcyon",
...
export const FIXTURE_REPORTING_SETS = [
  {
    name: "measurementConsumers/demo/reportingSets/helia_run1",
    displayName: "Helia Athletic Run 1",
    campaignGroup: { /* truthy, marks this as usable as a campaign group */ },
  },
  {
    name: "measurementConsumers/demo/reportingSets/halcyon_vc_q1",
    displayName: "Halcyon V-C Serum Launch",
    campaignGroup: {},
  },
  {
    name: "measurementConsumers/demo/reportingSets/aldea_aware_q1",
    displayName: "Aldea Coffee Brand Awareness",
    campaignGroup: {},
  },
];
